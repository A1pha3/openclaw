---
summary: "在 OpenClaw 中使用 Synthetic 兼容 Anthropic 的 API"
read_when:
  - 您想将 Synthetic 用作模型提供商
...
注意：OpenClaw 的 Anthropic 客户端会在基础 URL 后附加 `/v1`，因此请使用
...
- 如果您启用了模型允许列表（`agents.defaults.models`），请添加您计划使用的所有模型。
- 请参阅 [Model providers](/zh-CN/concepts/model-providers) 了解提供商规则。
